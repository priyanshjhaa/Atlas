  ...
  return (
    <div className={`app-frame ${collapsed ? "sidebar-collapsed" : ""}`}>
      ...
      <aside className={`app-sidebar ${mobileOpen ? "is-open" : ""}`}>
        ...
        <div className="sidebar-system-label"><span>Engineering intelligence</span><i>LIVE</i></div>
